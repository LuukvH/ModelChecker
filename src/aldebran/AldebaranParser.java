package aldebran;// Generated from C:/Users/laj/Documents/GitHub/ModelChecker\Aldebaran.g4 by ANTLR 4.5.1
...
public class AldebaranParser extends Parser {
	...
	public static final int
		RULE_kripkestructure = 0, RULE_aut_header = 1, RULE_first_state = 2, RULE_nr_of_transitions = 3, 
		RULE_nr_of_states = 4, RULE_aut_edge = 5, RULE_start_state = 6, RULE_label = 7, 
		RULE_end_state = 8;
	public static final String[] ruleNames = {
		"kripkestructure", "aut_header", "first_state", "nr_of_transitions", "nr_of_states", 
	...
	public static class KripkestructureContext extends ParserRuleContext {
		...
		public KripkestructureContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_kripkestructure; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterKripkestructure(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitKripkestructure(this);
		}
		@Override
	...
	public final KripkestructureContext kripkestructure() throws RecognitionException {
		KripkestructureContext _localctx = new KripkestructureContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_kripkestructure);
		int _la;
		try {
	...
	public static class Aut_headerContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterAut_header(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitAut_header(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class First_stateContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterFirst_state(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitFirst_state(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Nr_of_transitionsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterNr_of_transitions(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitNr_of_transitions(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Nr_of_statesContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterNr_of_states(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitNr_of_states(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Aut_edgeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterAut_edge(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitAut_edge(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Start_stateContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterStart_state(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitStart_state(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class LabelContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterLabel(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitLabel(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class End_stateContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).enterEnd_state(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AldebaranListener ) ((AldebaranListener)listener).exitEnd_state(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static final String _serializedATN =
		...
		"\27\n\2\f\2\16\2\32\13\2\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\4\3\4\3\5\3"+
		"\5\3\6\3\6\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\7\3\b\3\b\3\t\3\t\3\n\3\n\3\n"+
		"\2\2\13\2\4\6\b\n\f\16\20\22\2\2/\2\24\3\2\2\2\4\33\3\2\2\2\6#\3\2\2\2"+
		"\b%\3\2\2\2\n\'\3\2\2\2\f)\3\2\2\2\16\61\3\2\2\2\20\63\3\2\2\2\22\65\3"+
		"\2\2\2\24\30\5\4\3\2\25\27\5\f\7\2\26\25\3\2\2\2\27\32\3\2\2\2\30\26\3"+
		"\2\2\2\30\31\3\2\2\2\31\3\3\2\2\2\32\30\3\2\2\2\33\34\7\3\2\2\34\35\5"+
		"\6\4\2\35\36\7\4\2\2\36\37\5\b\5\2\37 \7\4\2\2 !\5\n\6\2!\"\7\5\2\2\""+
		"\5\3\2\2\2#$\7\t\2\2$\7\3\2\2\2%&\7\t\2\2&\t\3\2\2\2\'(\7\t\2\2(\13\3"+
		"\2\2\2)*\7\6\2\2*+\5\16\b\2+,\7\7\2\2,-\5\20\t\2-.\7\b\2\2./\5\22\n\2"+
		"/\60\7\5\2\2\60\r\3\2\2\2\61\62\7\t\2\2\62\17\3\2\2\2\63\64\7\n\2\2\64"+
		"\21\3\2\2\2\65\66\7\t\2\2\66\23\3\2\2\2\3\30";
